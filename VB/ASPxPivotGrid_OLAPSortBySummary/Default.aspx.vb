...
Namespace ASPxPivotGrid_OLAPSortBySummary
	Partial Public Class _Default
		...
		Protected Overrides Sub OnInit(ByVal e As EventArgs)
			MyBase.OnInit(e)
			ASPxPivotGrid1.OLAPConnectionString = "provider=MSOLAP;data source=localhost;" & _
				"initial catalog='Adventure Works 2008';cube name='Adventure Works'"
		End Sub
		Protected Sub ASPxPivotGrid1_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			fieldMonth.SortBySummaryInfo.Conditions.Add( _
